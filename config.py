...
API_ID = int(getenv("API_ID", "20402718"))
API_HASH = getenv("API_HASH", "14de703801bf414bcffadfb59ae21fba")
...
SUPPORT_GRP = getenv("SUPPORT_GRP", "YARANA_TG")
UPDATE_CHNL = getenv("UPDATE_CHNL", "DX_INFO")
